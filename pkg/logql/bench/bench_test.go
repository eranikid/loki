...
const (
	...
	StoreMultiTenantDataObjV2Engine = "mutli-tenant-dataobj-engine"
...
//go:generate go run ./cmd/generate/main.go -size 2147483648 -dir ./data -tenant tenant0,tenant1,tenant2,tenant3,tenant4
